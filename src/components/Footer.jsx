        ...
        <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-4 md:text-left">
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2 text-gray-600">
              <li><span className="cursor-default hover:text-indigo-500">Home</span></li>
              <li><span className="cursor-default hover:text-indigo-500">Course</span></li>
              <li><span className="cursor-default hover:text-indigo-500">Coaching</span></li>
              <li><span className="cursor-default hover:text-indigo-500">Pricing</span></li>
              <li><span className="cursor-default hover:text-indigo-500">Blog</span></li>
              <li><span className="cursor-default hover:text-indigo-500">Transformations</span></li>
            </ul>
          </div>
